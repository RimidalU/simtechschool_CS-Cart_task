...
if (version_compare($php_value, '7.1.0', '<') || version_compare($php_value, '8.2.0', '>=')) {
    echo 'Your current PHP version ' . $php_value . ' isn\'t supported. CS-Cart supports PHP from 7.1.0 and up to (but not including) 8.2.0';
    die();
}

if (version_compare($php_value, '8.1.0', '>=')) {
