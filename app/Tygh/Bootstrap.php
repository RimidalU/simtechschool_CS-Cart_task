...
class Bootstrap
{
    ...
    public static function setConstants($server, $dir_root)
    {
        ...
        if (version_compare(PHP_VERSION, MIN_PHP_VERSION, '<') || version_compare(PHP_VERSION, MAX_PHP_VERSION, '>=')) {
            die('CS-Cart supports PHP from <b>' . MIN_PHP_VERSION . '</b> and up to (but not including) <b>' . MAX_PHP_VERSION . '</b>. Your current PHP version is <b>' . PHP_VERSION . '</b>, please ask your host to change it.');
        }
    }
