...
use Tygh\Addons\RusBoxberry\CustomListCitiesRequest;
use Tygh\Addons\RusBoxberry\CustomListPointsRequest;
use Tygh\Http;
use Tygh\Registry;
...
class BoxberryClient extends Client
{
     ...
     */
    public function getPickupPoints($city_name, $region = null, $country_code = 'RU', $service_code = '')
    {
        ...
        if (!isset($boxberry_cities)) {
            ...
            $cities_list->setCountryCode($country_code);
        ...
        if (!isset($points[$city_name])) {
            ...
            if (!empty($city_code)) {
                ...
                $pickups_list->setCountryCode($country_code);
                $prepaid = strpos($service_code, 'prepaid') !== false;
                $pickups_list->setPrepaid((int) $prepaid);
    ...
    /**
     * Returns request object for ListCities request.
     *
     * @return CustomListCitiesRequest
     */
    public static function getListCities()
    {
        return new CustomListCitiesRequest();
    }

    /**
     * Returns request object for ListPoints request.
     *
     * @return CustomListPointsRequest
     */
    public static function getListPoints()
    {
        return new CustomListPointsRequest();
    }
