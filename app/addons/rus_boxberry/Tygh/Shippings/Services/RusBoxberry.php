...
class RusBoxberry implements IService, IPickupService
{
    ...
    public function getSimpleRates()
    {
        ...
        if ($service_code == 'boxberry_courier' || $service_code == 'boxberry_courier_prepaid') {
            ...
            $country_code = isset($package_info['location']['country']) ? $package_info['location']['country'] : '';
            ...
            try {
                $pickups_list = $this->client->getPickupPoints($city, $region, $country_code, $service_code);
