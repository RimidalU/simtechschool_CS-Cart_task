        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select name="product_data[yml2_offer_type]" id="yml2_offer_type">
                    <option value="" {if empty($product_data.yml2_parent_offer_type_name) && empty($product_data.yml2_offer_type)}selected="selected"{/if}>{if !empty($yml2_parent_offer_type_name)}{__('yml_export.category_value', ['[default]' => __($yml2_parent_offer_type_name)])}{else}{__('yml_export.use_category_value')}{/if}</option>
                ...
                <p class="muted description">{__("tt_addons_yml_export_hooks_products_tabs_content_post_yml2_offer_type") nofilter}</p>
            </div>
        </div>
