...
{__("text_yandex_money_tech_urls", ["[avisio_url]" => $avisio_url, "[check_url]" => $check_url, "[fail_url]" => $fail_url, "[success_url]" => $success_url]) nofilter}
{/hook}
...
{if !$check_https}
{__("text_yandex_money_https") nofilter}
{/if}
{/hook}
</div>
