...
<div class="btn-group {$class}" {if $select_container_id}id="{$select_container_id}"{/if}>
    <a class="btn btn-text dropdown-toggle {$button_class}" id="sw_select_{$selected_id}_wrap_{$suffix}" data-toggle="dropdown">
        {if $display_icons}
            ...
            {foreach $items as $id => $item}
                <li class="{$dropdown_menu_item_class}">
                    <a name="{$id}"
                       ...
                       class="{$dropdown_menu_item_link_class}"
                       {if $target_id}
                           class="cm-ajax"
...
<div class="cm-popup-box btn-group {if $class}{$class}{/if}">
    ...
    <input type="hidden"
           ...
           value="{$selected_key}"
    />
    <a id="sw_{$select_container_name}" class="dropdown-toggle btn-text btn {if $text_wrap}dropdown-toggle--text-wrap{/if} {$button_class}" data-toggle="dropdown">
    {$selected_name}
        <span class="caret"></span>
    </a>
