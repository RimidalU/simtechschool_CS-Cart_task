            ...
            <div class="control-group">
                ...
                <div class="controls">
                    {include file="common/calendar.tpl" 
                        ...
                        date_name="departments_data[timestamp]" 
                        date_val=$departments_data.timestamp|default:$smarty.const.TIME 
        ...
        {capture name="buttons"}
            {if !$id}
                {include file="buttons/save_cancel.tpl" 
                    ...
                    but_name="dispatch[products.update_department]"
                }
            {else}
            ...
            {capture name="tools_list"}
                <li>
                    {btn 
                        ...
                        text=__("delete") 
                        class="cm-confirm" 
                        href="products.delete_department?department_id=`$department.department_id`" 
                        method="POST"
                    }
                </li>
            {/capture}
