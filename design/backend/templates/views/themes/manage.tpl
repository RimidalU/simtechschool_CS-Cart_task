                                ...
                                <td class="right btn-toolbar btn-toolbar--theme-editor" data-th="&nbsp;">
                                    ...
                                    {if $has_styles}
                                        {include file="buttons/button.tpl"
                                            but_href="customization.update_mode?type=theme_editor&status=enable&s_layout={$available_layout.layout_id}&s_storefront={$storefront->storefront_id}{if $to_storefront}&to_storefront={$to_storefront}{/if}"
                                    ...
                                    {if !$act_as_vendor}
                                        {include file="buttons/button.tpl"
                                            but_href="customization.update_mode?type=block_manager&status=enable&s_layout={$available_layout.layout_id}&s_storefront={$storefront->storefront_id}{if $to_storefront}&to_storefront={$to_storefront}{/if}"
                                    ...
                                    {/if}
                                    {include file="buttons/button.tpl"
                                        but_href="customization.update_mode?type=live_editor&status=enable&s_layout={$available_layout.layout_id}&s_storefront={$storefront->storefront_id}{if $to_storefront}&to_storefront={$to_storefront}{/if}"
