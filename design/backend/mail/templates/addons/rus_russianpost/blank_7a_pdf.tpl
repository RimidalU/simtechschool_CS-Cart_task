...
<body style="width: 198mm; height: 141mm;">
    <div style="top: {$addons.rus_russianpost.7a_top}mm; left: {$addons.rus_russianpost.7a_left}mm; width: 198mm; height: 141mm; position: relative;" >
        ...
        {if $data.type_mailing == 'package'}
            <span style="position: absolute; height: 5mm; width: 5mm; top: 15mm; left: 60mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
        {else}
            <span style="position: absolute; height: 5mm; width: 5mm; top: 19mm; left: 60mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
        {/if}

        {if !empty($data.not_total) && $data.not_total == 'Y'}
            <span style="position: absolute; height: 5mm; width: 5mm; top: 15mm; left: 99.5mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
        ...
        {if !empty($data.imposed_total) && $data.imposed_total == 'Y'}
            <span style="position: absolute; height: 5mm; width: 5mm; top: 18mm; left: 99.5mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
            <span style="position: absolute; height: 5mm; width: 85mm; top: 54.5mm; left: 100mm; text-align: center; font: 11pt 'Arial';">{$data.total_imposed}</span>
        {/if}

        <span style="position: absolute; height: 9mm; width: 70mm; top: 49.5mm; left: 23mm; font: 11pt 'Arial';">{if $data.sender == '1'}{$data.whom} {$data.whom2}{else}{$data.fiz_fio} {$data.fiz_fio2}{/if}</span>
        ...
        {if $data.sms_for_sender == 'Y'}
            <div style="position: absolute; height: 4mm; width: 40mm; top: 85mm; left: 23mm; font: 11pt 'Arial'; margin:0;">
            ...
            <span style="position: absolute; height: 5mm; width: 5mm; top: 89mm; left: 17.5mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
        {/if}
        <span style="position: absolute; height: 4mm; width: 23mm; top: 85mm; left: 70mm; font: 11pt 'Arial'; letter-spacing: 7.6pt;">
            {if $data.sender == '1'}
        ...
        <span style="position: absolute; height: 5mm; width: 80mm; top: 77.5mm; left: 105mm; font: 11pt 'Arial';">{$data.from_whom} {$data.from_whom2}</span>
        <span style="position: absolute; height: 15mm; width: 80mm; top: 93.5mm; left: 100mm; font: 11pt 'Arial'; line-height: 14pt;">{$data.sender_address} {$data.sender_address2}</span>
        {if $data.sms_for_recepient == 'Y'}
            ...
            <span style="position: absolute; height: 5mm; width: 5mm; top: 118mm; left: 101mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
        {/if}
