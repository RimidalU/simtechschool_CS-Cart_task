...
<body style="width: 297mm; height: 210mm;">
    <div style="top: {$addons.rus_russianpost.7p_top}mm; left: {$addons.rus_russianpost.7p_left}mm; width: 198mm; height: 141mm; position: relative;" >
        ...
        {if $data.type_mailing == 'package'}
            <span style="position: absolute; height: 5mm; width: 5mm; top: 14mm; left: 62mm; text-align: center; font: 12pt 'Arial';">&#xD7;</span>
        {else}
            <span style="position: absolute; height: 5mm; width: 5mm; top: 21mm; left: 62mm; text-align: center; font: 12pt 'Arial';">&#xD7;</span>
        {/if}

        {if !empty($data.not_total) && $data.not_total == 'Y'}
            <span style="position: absolute; height: 5mm; width: 5mm; top: 13.5mm; left: 99mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
        ...
        {if !empty($data.imposed_total) && $data.imposed_total == 'Y'}
            <span style="position: absolute; height: 5mm; width: 5mm; top: 16.5mm; left: 99mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
            <span style="position: absolute; height: 5mm; width: 85mm; top: 56mm; left: 100mm; text-align: center; font: 11pt 'Arial';">{$data.total_imposed}</span>
        {/if}

        <span style="position: absolute; height: 5mm; width: 70mm; top: 51mm; left: 23mm; font: 11pt 'Arial';">{if $data.sender == '1'}{$data.whom} {$data.whom2}{else}{$data.fiz_fio} {$data.fiz_fio2}{/if}</span>
        ...
        {if $data.sms_for_sender == 'Y'}
            ...
            <span style="position: absolute; height: 5mm; width: 5mm; top: 87mm; left: 17.5mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
        {/if}
        ...
        <span style="position: absolute; height: 5mm; width: 80mm; top: 76mm; left: 105mm; font: 11pt 'Arial';">{$data.from_whom} {$data.from_whom2}</span>
        ...
        {if $data.sms_for_recepient == 'Y'}
            <div style="position: absolute; height: 4mm; width: 40mm; top: 108.5mm; left: 106mm; font: 11pt 'Arial'; margin:0;">
            ...
            <span style="position: absolute; height: 5mm; width: 5mm; top: 112.5mm; left: 100.5mm; text-align: center; font: 9pt 'Arial';">&#xD7;</span>
        {/if}
        <span style="position: absolute; height: 4mm; width: 23mm; top: 108.5mm; left: 153mm; font: 11pt 'Arial'; letter-spacing: 7.6pt;">
