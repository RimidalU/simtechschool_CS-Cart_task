...
<body style="width: 210mm; height: 293mm;">
    <div style="top: {$addons.rus_russianpost.112ep_top}mm; left: {$addons.rus_russianpost.112ep_left}mm; width: {$addons.rus_russianpost.112_list_width}mm; height: {$addons.rus_russianpost.112_list_height}mm; position: relative;" >
        {if $data.print_bg == 'Y'}
        ...
        {if !empty($data.imposed_total) && $data.imposed_total == 'Y'}
            <span style="position: absolute; height: 5mm; width: 5mm; top: 68mm; left: 17mm; text-align: center; font: 30pt 'Arial';">&#xD7;</span>
            <span style="position: absolute; height: 5mm; width: 15mm; top: 66mm; left: 19mm; text-align: center; font: 11pt 'Arial';">{$data.imposed_rub}</span>
            <span style="position: absolute; height: 5mm; width: 7mm; top: 66mm; left: 42mm; text-align: center; font: 11pt 'Arial';">{$data.imposed_kop}</span>
        ...
        {if $data.sms_for_sender == 'Y'}
            <div style="position: absolute; height: 4mm; width: 35mm; top: 70mm; left: 151mm; font: 11pt 'Arial'; margin:0;">
        ...
        {if $data.sms_for_recepient == 'Y'}
            <div style="position: absolute; height: 4mm; width: 35mm; top: 76mm; left: 151mm; font: 11pt 'Arial'; margin:0;">
            ...
            <span style="position: absolute; height: 5mm; width: 4mm; top: 74mm; left: 59mm; text-align: center; font: 15pt 'Arial';">&#xD7;</span>
        {/if}

        <span style="position: absolute; height: 5mm; width: 160mm; top: 82.5mm; left: 27mm; font: 11pt 'Arial';">{if $data.sender == '1'}{$data.whom} {$data.whom2}{else}{$data.fiz_fio} {$data.fiz_fio2}{/if}</span>
        ...
        <span style="position: absolute; height: 5mm; width: 25mm; top: 95mm; left: 160mm; font: 11pt 'Arial'; letter-spacing: 7.6pt;">
            {if $data.sender == '1'}
        ...
        <div style="position: absolute; height: 4.5mm; width: 55mm; top: 103mm; left: 39mm; font: 11pt 'Arial'; margin: 0;">
        ...
        <div style="position: absolute; height: 4.5mm; width: 55mm; top: 110.5mm; left: 39mm; font: 11pt 'Arial'; margin: 0;">
        ...
        <div style="position: absolute; height: 5mm; width: 50mm; top: 121mm; left: 27mm; font: 11pt 'Arial'; margin: 0;">
        ...
        <div style="position: absolute; height: 5mm; width: 85mm; top: 121mm; left: 102.5mm; font: 11pt 'Arial'; margin: 0;">
        ...
        <span style="position: absolute; height: 5mm; width: 130mm; top: 126.5mm; left: 55mm; font: 11pt 'Arial';">{$data.bank}</span>
        <div style="position: absolute; height: 5mm; width: 85mm; top: 132.5mm; left: 34mm; font: 11pt 'Arial'; margin: 0;">
        ...
        <div style="position: absolute; height: 5mm; width: 38mm; top: 132.5mm; left: 149mm; font: 11pt 'Arial'; margin: 0;">
        ...
        <span style="position: absolute; height: 5mm; width: 150mm; top: 138mm; left: 35mm; font: 11pt 'Arial';">{$data.from_whom} {$data.from_whom2}</span>
        <span style="position: absolute; height: 10mm; width: 170mm; top: 145mm; left: 17mm; font: 11pt 'Arial'; text-indent: 35mm; line-height: 14pt;">{$data.sender_address} {$data.sender_address2}</span>
